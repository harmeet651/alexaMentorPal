    ...
    if(flag==0)
      {
        //this.emit(':ask', '<audio src= "https://s3.amazonaws.com/harmeetsingh/Daaru+Band-(Mr-Jatt.com).mp3" />');
         this.response.speak('Here is your answer.').audioPlayerPlay('REPLACE_ALL', streamInfo.url1, streamInfo.url1, null, 0);
        this.emit(':responseReady');
      }
    else
      {
        //this.emit(':ask', '<audio src= "https://s3.amazonaws.com/harmeetsingh/Daaru+Band-(Mr-Jatt.com).mp3" />');
        this.response.speak('Here is your answer.').audioPlayerPlay('REPLACE_ALL', streamInfo.url2, streamInfo.url2, null, 0);
        this.emit(':responseReady');
      }
