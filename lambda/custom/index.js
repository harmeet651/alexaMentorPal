...
var streamInfo = {
  ...
  url: 'https://www.mediacollege.com/downloads/sound-effects/nature/seaside/beach-01.mp3',
  image: {
...
//     this.emit(':tell', PlayStream);
 // },
  'PlayStream': function() {
    ...
    if(flag==0)
      {
        this.emit(':ask', '<audio src= "https://www.mediacollege.com/downloads/sound-effects/nature/seaside/beach-01.mp3" />');
      }
    else
      {
        this.emit(':ask', 'Answer Two');
      }
